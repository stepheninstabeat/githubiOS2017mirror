...
public class ZoomChartViewJob: ChartViewPortJob
{
    ...
    public override func doJob()
    {
        ...
        _ = viewPortHandler.refresh(newMatrix: matrix, chart: view, invalidate: false)
        
        let valsInView = (view as! BarLineChartViewBase).getDeltaY(axis: axisDependency) / viewPortHandler.scaleY
