...
public class PieChartView: PieRadarChartViewBase
{
    ...
    private func calcAngles()
    {
        ...
        for i in 0 ..< data.dataSetCount
        {
            ...
            for j in 0 ..< entryCount
            {
                ...
                _drawAngles.append(calcAngle(value: abs(e.value), yValueSum: yValueSum))
    ...
    public override func indexForAngle(angle: CGFloat) -> Int
    {
        ...
        let a = ChartUtils.normalizedAngleFromAngle(angle: angle - self.rotationAngle)
    ...
    public func dataSetIndexForIndex(xIndex: Int) -> Int
    {
        ...
        {
            if (dataSets[i].entryForXIndex(x: xIndex) !== nil)
            {
                return i
            }
        }
