...
public class LineScatterCandleRadarChartDataSet: BarLineScatterCandleBubbleChartDataSet, ILineScatterCandleRadarChartDataSet
{
    ...
    public var setHigligtSelectedValueEnabled: Bool = false
    
    public var isHigligtSelectedValueEnabled: Bool { return setHigligtSelectedValueEnabled }
    ...
    {
        let copy = super.copyWithZone(zone: zone) as! LineScatterCandleRadarChartDataSet
