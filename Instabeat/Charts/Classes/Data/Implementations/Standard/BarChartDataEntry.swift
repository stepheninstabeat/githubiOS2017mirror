...
public class BarChartDataEntry: ChartDataEntry
{
    ...
    {
        super.init(value: BarChartDataEntry.calcSum(vals: values), xIndex: xIndex, data: label)
        self.values = values
    }
    
    /// Constructor for stacked bar entries with colors.
    public init(values: [Double], xIndex: Int, colors: [UIColor])
    {
        super.init(value: BarChartDataEntry.calcSum(vals: values), xIndex: xIndex, data: colors)
        self.values = values
    }
    
    /// Constructor for normal bars (not stacked).
    override init(value: Double, xIndex: Int, data: Any?) {
