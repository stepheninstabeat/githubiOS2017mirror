...
public class LineChartDataSet: LineRadarChartDataSet, ILineChartDataSet
{
    ...
    public var drawInfoEnabled: Bool = false
    
    public var isDrawInfoEnabled: Bool { return drawInfoEnabled }
    
    public var drawValueInfoEnabled: Bool = false
    
    public var isDrawValueInfoEnabled: Bool { return drawValueInfoEnabled }
    ...
    {
        let copy = super.copyWithZone(zone: zone) as! LineChartDataSet
