...
public class BarLineScatterCandleBubbleChartDataSet: ChartDataSet, IBarLineScatterCandleBubbleChartDataSet
{
    ...
    public var drawCircleHighlightIndicatorEnabled = false
    
    public var isCircleHighlightIndicatorEnabled: Bool { return drawCircleHighlightIndicatorEnabled }
    
    // MARK: - NSCopying
    
    public override func copyWithZone(zone: NSZone) -> AnyObject
    {
        let copy = super.copyWithZone(zone: zone) as! BarLineScatterCandleBubbleChartDataSet
